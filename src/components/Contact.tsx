...
const links = [
  {
    label: "Email",
    value: "sj.kang@outlook.com.au",
    href: "mailto:sj.kang@outlook.com.au",
    icon: (
  ...
  {
    label: "GitHub",
    value: "github.com/SJKangAU",
    href: "https://github.com/SJKangAU",
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto flex flex-col items-center text-center">
        ...
        <p className={`mb-12 text-base max-w-lg ${muted}`}>
          I'm open to new opportunities, collaborations, or just a chat. Feel
